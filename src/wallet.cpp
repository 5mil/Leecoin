...
// LEE: total coins staked (non-spendable until maturity)
...
// LEE: check 'spent' consistency between wallet and txindex
// LEE: fix wallet spent state according to txindex
...
// LEE: disable transaction (only for coinstake)
