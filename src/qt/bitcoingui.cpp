    ...
    rpcConsole(0)
{
	...
	"#spacer { background:rgb(35, 35, 35);border:none; }" 
	"#toolbar2 { border:none;width:10px; background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(35, 35, 35), stop: 1 rgb(228,27,35)); }"
	
	"#toolbar { border:none;height:100%;padding-top:20px; background: rgb(35, 35, 35); text-align: left; color: white;min-width:200px;max-width:200px;} QToolBar QToolButton:hover {background-color:qlineargradient(x1: 0, y1: 0, x2: 2, y2: 2,stop: 0 rgb(35, 35, 35), stop: 1 rgb(228,27,35),stop: 2 rgb(35, 35, 35));} QToolBar QToolButton { font-family:Verdana Regular;padding-left:20px;padding-right:200px;padding-top:10px;padding-bottom:10px; width:100%; color: white; text-align: left; background-color: rgb(35, 35, 35) }" 
	
	"#labelMiningIcon { padding-left:5px;font-family:Verdana Regular;width:100%;font-size:12px;text-align:center;color:white; } QMenu { background: rgb(35, 35, 35); color:white; padding-bottom:10px; } QMenu::item { color:white; background-color: transparent; } QMenu::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(35, 35, 35), stop: 1 rgb(228,27,35)); } QMenuBar { background: rgb(35, 35, 35); color:white; } QMenuBar::item { font-size:12px;padding-bottom:12px;padding-top:12px;padding-left:15px;padding-right:15px;color:white; background-color: transparent; } QMenuBar::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(35, 35, 35), stop: 1 rgb(228,27,35)); }");
    ...
    frameBlocks->setStyleSheet("frameBlocks { background: rgb(36,36,36); }");
...
void BitcoinGUI::createActions()
{
	...
	//chatAction = new QAction(QIcon(":/icons/irc"), tr("&Social"), this);
    //chatAction->setToolTip(tr("View IRC chat and links"));
	...
	blockAction = new QAction(QIcon(":/icons/block"), tr("&Chain"), this);
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    else
    {
        ...
        labelBlocksIcon->setPixmap(QIcon(":/icons/notsynced").pixmap(16,16));
